...
export default function OrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const STATUS_OPTIONS: Order['status'][] = ['Hazırlanıyor', 'Kargoda', 'Teslim Edildi', 'İptal'];
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase ${order.status === 'Hazırlanıyor' ? 'bg-yellow-100 text-yellow-700' :
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div className="relative border-l-2 border-gray-200 ml-3 space-y-8 pl-8 pb-2">
                            ...
                            <div className="relative">
                                <div className={`absolute -left-[39px] w-5 h-5 rounded-full border-4 border-white shadow-sm ${order.status !== 'Hazırlanıyor' && order.status !== 'İptal' ? 'bg-blue-500' : 'bg-gray-300'}`}></div>
